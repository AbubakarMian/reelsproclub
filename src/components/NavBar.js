...
export default function Nav_bar_area(props) {
  ...
  const updateContextState = props.contextApi.updateContextState;
  ...
  console.log("context as", updateContextState);
    ...
    <>
      ...
      <Navbar key="xl" expand="lg" className="bg-body-tertiary" variant="light">
        <Container fluid className="nav_back">
          ...
          <Navbar.Brand href="#">
            {" "}
            <img className="logo_brand" src="./../images/new1.png"></img>
          </Navbar.Brand>
          <Navbar.Offcanvas
          ...
          >
            <Offcanvas.Header>
              <Offcanvas.Title id={`offcanvasNavbarLabel-expand-lg`}>
                <div onClick={() => {}}>{contextState.user.name} </div>
                <div>
                  <img
